...
export default {
  ...
  setup() {
    ...
    const agencyColumn = ref(null)
    const freelanceColumn = ref(null)
    ...
    onMounted(() => {
      ...
      .from(agencyColumn.value.querySelectorAll('.work-item'), {
        opacity: 0,
        y: 20,
        stagger: 0.2
      }, '-=0.5')
      .from(freelanceColumn.value.querySelectorAll('.work-item'), {
        opacity: 0,
        y: 20,
        stagger: 0.2
      }, '-=0.8')
